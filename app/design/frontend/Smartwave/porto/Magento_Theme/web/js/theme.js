...
require([
    ...
    $(document).ready(function(){
        ...
        var top_message_cookie = $.cookie('top_message_cookie');

        if(top_message_cookie != null && top_message_cookie == 'shown') {
            $('#top_message').removeClass("visible-lg visible-md visible-sm").hide();
        }

        $('#close-btn').on('click', function(){
            $.cookie('top_message_cookie','shown',{path: '/', expires: 99999});
            $('#top_message').removeClass("visible-lg visible-md visible-sm").fadeOut();
        });
    });
});
require([
