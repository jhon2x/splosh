...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()->newTable(
            ...
            'customer_group_id',
            $this->getCustomerGroupColumnType($installer),
            null,
            ['unsigned' => true, 'nullable' => false, 'primary' => true],
            'Customer Group Id'
        )->addIndex(
     ...
     * @return string
     */
    protected function getCustomerGroupColumnType(SchemaSetupInterface $installer)
    {
        $customerGroupTable  = $installer->getConnection()->describeTable($installer->getTable('customer_group'));
