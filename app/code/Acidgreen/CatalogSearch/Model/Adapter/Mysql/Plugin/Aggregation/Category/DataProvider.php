<?php
namespace Acidgreen\CatalogSearch\Model\Adapter\Mysql\Plugin\Aggregation\Category;
...
/**
 * DataProvider plugin class for SPL-441 filter issues
 */
class DataProvider
{
    /**
    ...
    public function aroundGetDataSet(
        \Acidgreen\CatalogSearch\Model\Adapter\Mysql\Aggregation\DataProvider $subject,
        \Closure $proceed,
