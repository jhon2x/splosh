...
namespace Acidgreen\CatalogSearch\Model\Search\FilterMapper;
...
/**
 * Override class \Magento\CatalogSearch\Model\Search\FilterMapper\TermDropdownStrategy
 ...
 */
class TermDropdownStrategy extends \Magento\CatalogSearch\Model\Search\FilterMapper\TermDropdownStrategy
{
    /**
     * @var AliasResolver
     */
    ...
    /**
     * Override parent::isAddStockFilter() private method
     * return false if we're dealing with B2B stores
     * @return bool
     */
    private function isAddStockFilter()
    {
        if (preg_match("/b2b/", $this->storeManager->getWebsite()->getCode())) {
            return false;
        }
