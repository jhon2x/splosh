...
return [
    'modules' => [
        ...
        'Magento_Worldpay' => 1,
        'Acidgreen_AddressAutocomplete' => 1,
        'Acidgreen_Catalog' => 1,
        'Acidgreen_Exo' => 1,
        'Acidgreen_CatalogInventory' => 1,
        'Acidgreen_CatalogSearch' => 1,
        'Acidgreen_SploshBox' => 1,
        'Acidgreen_CheckoutSteps' => 1,
        'Acidgreen_Custom503' => 1,
        'Acidgreen_Customer' => 1,
        'Acidgreen_CustomerImportExport' => 1,
        'Smartwave_Megamenu' => 1,
        'Acidgreen_SploshExo' => 1,
        'Acidgreen_ExoStockist' => 1,
        'Acidgreen_GoogleCustomerReviews' => 1,
        'Acidgreen_GoogleTagManager' => 1,
        'Acidgreen_LoadingMask' => 1,
        'Acidgreen_MagentoSales' => 1,
        'Acidgreen_OrderComments' => 1,
        'Acidgreen_Quote' => 1,
        'Acidgreen_SalesRule' => 1,
        'Acidgreen_ScalableInventory' => 1,
        'Acidgreen_SmartwaveFilterProducts' => 1,
        'Acidgreen_SploshBackorder' => 1,
        'Acidgreen_Checkout' => 1,
        'Acidgreen_SploshCatalogData' => 1,
        'Acidgreen_B2BCustomization' => 1,
        'Acidgreen_TargetRule' => 1,
        'Acidgreen_Theme' => 1,
        'Acidgreen_WebsiteRestriction' => 1,
        'Acidgreen_Wishlist' => 1,
        'Afterpay_Afterpay' => 1,
        ...
        'Acidgreen_CustomerRestrictions' => 1,
        'Smartwave_Porto' => 1,
        'Smartwave_Socialfeeds' => 1,
        'Splosh_ExtendCatalog' => 1,
        'Splosh_ExtendCatalogInventory' => 1,
        'Splosh_ExtendMageplazaLayeredNavigation' => 1,
        'Splosh_ProductLabels' => 1,
        'Splosh_SalesRep' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1
    ]
